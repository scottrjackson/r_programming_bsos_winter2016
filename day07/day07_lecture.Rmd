...
los.fusion$firstvalue.new<-ifelse(los.fusion$firstvalue=="abortion","A","M")

ggplot(los.fusion, aes(x = firstval_fusion, y = secondval_fusion)) + geom_text(aes(label = firstvalue.new))
